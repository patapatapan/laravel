...
<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Montserrat&amp;display=swap"rel="stylesheet'><link rel="stylesheet" href="gallery/style.css">
		...
		<div class="cards__wrapper">
			<div class="card current--card">
				<div class="card__image">
					<img src="https://cdn.wallpapersafari.com/0/4/k65oQJ.jpg" alt="" />
				</div>
			</div>

			<div class="card next--card">
				<div class="card__image">
					<img src="https://wallpaperaccess.com/full/3197983.jpg" alt="" />
				</div>
			</div>

			<div class="card previous--card">
				<div class="card__image">
					<img src="https://static.zerochan.net/Dialga.full.3672389.jpg" alt="" />
				</div>
			</div>
		</div>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.3.3/gsap.min.js'></script><script  src="gallery/script.js"></script>
